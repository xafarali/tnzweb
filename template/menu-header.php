    ...
    <div class="col-12">
        <nav class="navigation top-main-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="lv1"><a href="/showcase/" class="_dropdown-toggle" rel="bookmark">Case Studies</a></li>
                <li class="lv1"><a href="/contact/" class="_dropdown-toggle" rel="bookmark">Contact</a></li>
            </ul>
        </nav>
    </div>
</div>
