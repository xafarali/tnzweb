...
<div class="auto-scroll-wrapper fs" id="sec-client-home">
        <div class="bg-illus">
            <div class="svg-ribbon">
                <img src="/images/illus-home-client.svg" class="svg-import svg-ribbon" alt="">
            </div>
            <!-- <div class="svg-text">
                <img src="/images/illus-home-client-text.svg" class="svg-import" alt="">
            </div> -->
            
            <div class="anim-bubble">
                <div class="tag tag-1 has-icon anim-bubble">
                    <span class="fa fa-star badge"></span>
                    Parnter with Giant Globals
                </div>
            </div>
            

            <div class="anim-bubble">
                <div class="tag tag-2 has-icon">
                    <span class="fa fa-anchor badge"></span>
                    Shaping Ideas into Reality
                </div>
            </div>
             
            <div class="anim-bubble">
                <div class="tag tag-3 has-icon anim-bubble">
                    <span class="fa fa-thumbs-up badge"></span>
                    Excellence. Trust. Success.
                </div>
            </div>
        ...
        <div class="section lg auto-scroll mc fs">
            <div class="container  _wow fadeInUpBig">
