...
?>
        ...
        <div class="container-xl">
            <div class="section sm">
                <div class="row mc text-center section-slider-phone  srv-logo-wrapper ">
                    <div class="col-md-2"><img src="/images/logo-google.svg" alt="" /></div>
                    <div class="col-md-2"><img src="/images/logo-googlecloud.svg" alt="" /></div>
                    <div class="col-md-2"><img src="/images/logo-digital-ocean.svg" alt="" /></div>
                    <div class="col-md-2"><img src="/images/logo-aws.svg" alt="" /></div>
                    <div class="col-md-2"><img src="/images/logo-microsoft.svg" alt="" /></div>
                    <div class="col-md-2"><img src="/images/logo-azure.svg" alt="" /></div>
    ...
    <!-- Sepia Offers -->
    <div class="auto-scroll-wrapper section fs bg-light-blue cloud-why-sepia" id="area-why-sepia">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="container-lg no-margin">
                        <h3>Sepia Solutions</h3>
                        <h2>Value Added Services</h2>
                        <p>After you have made the decision that would change your business forever, we provide you with our full technical support, giving you full deployment assistance, and taking you successfully to the last step of cloud migration. Our expertise will help you to recognize the full capabilities of Microsoft Azure and it's benefits, including how the team's productivity increases with the integrated Azure tools.</p>
                    </div>
                    
                    <div class="row section-slider" data-slide="5" data-slide-tablet="4" data-slide-arrow="no">

                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-free-assessment.svg" alt="" class="ico">
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-free-consultancy.svg" alt="" class="ico">
                                    <h5>Personalized Consultancy</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-deployment.svg" alt="" class="ico">
                                    <h5>Deployment Assistance</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-cloud-mig2.svg" alt="" class="ico">
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-support.svg" alt="" class="ico">
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-management.svg" alt="" class="ico">
                                    <h5>Day to Day Management</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-resource-management.svg" alt="" class="ico">
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-reduce-cost.svg" alt="" class="ico">
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-rnd-2.svg" alt="" class="ico">
                                    <h5>Develop &amp; Test</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card square">
                                <div class="content">
                                    <img src="/images/cloud/ftr-analysis.svg" alt="" class="ico">
