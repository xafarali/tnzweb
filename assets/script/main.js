...
// @TODO loader in % or total images
    ...
    function bind_slider() {
        ...
        if ( $('___.section-slider').length && (! $('.section-slider').hasClass('slick-initialized') )) {
            ...
            $('.section-slider').each( function ( i,v ) {
                ...
                var $_thumb_ctrl = $.trim($_slideThis.attr('data-slide-pager')) ? $.trim($_slideThis.attr('data-slide-pager')) : null,
                    num_slides = $_slideThis.attr('data-slide') ? parseInt($_slideThis.attr('data-slide')) : 3,
                    num_slides_phone = $_slideThis.attr('data-slide-phone') ? parseInt($_slideThis.attr('data-slide-phone')) : 1,
                    num_slides_tablet = $_slideThis.attr('data-slide-tablet') ? parseInt($_slideThis.attr('data-slide-tablet')) : 2,
                    $_thumb_parent = $.trim($_slideThis.attr('data-slide-parent')) ? $.trim($_slideThis.attr('data-slide-parent')) : null,
                    $_arrow_desk  =  $.trim($_slideThis.attr('data-slide-arrow')) ? false : true,
                    $_thumb_static_ctrl =  $.trim($_slideThis.attr('data-slide-pager-static')) ? $.trim($_slideThis.attr('data-slide-pager-static')) : null,
                ...
                if (!$($_thumb_ctrl).length) {
                    ...
                    $($_thumb_ctrl).find('li').on('click', function (e) {
                ...
                if ( $($_thumb_static_ctrl).length ) {
                    ...
                    $($_thumb_parent).on('afterChange', function(a,b,ind) {
                        ...
                        _click_set.removeClass('active').eq(ind).addClass('active')
                    });
            ...
            if( $('.section-slider-phone').length && is_phone()) {
                ...
                } else if ( $('.section-slider-phone').length &&   $('.section-slider-phone').hasClass('slick-initialized')) {
        ...
        */
        ...
        xash_svg_import( $svg_r, function () {
            ...
            xash_svg_ready(null,0, function () {
                ...
                $('html').waitForImages(true).progress(function(loaded,count,success) {
    ...
    if ( x_run_) {
        ...
        $('body').on('imagesLoaded', function () {
            ...
            // bind slider
            if( $('body').find('.section-slider').length || $('body').find('.section-slider-phone') ) {
                bind_slider();
            }
            ...
            $('body').on('click', '.menu-burger.menu-btn', function (e) {
                ...
                if ($('body').hasClass('menu-visible')) {
                    ...
                    new TimelineMax()
                        ...
                        .staggerFromTo( __$menu_items, .35, {
                            y: "+=30%",
                            autoAlpha: 0
                        },
                        {
    ...
    // </editor-fold>
        ...
        if ($('body').hasClass('page-srv-branding')) {
            ...
            //-----------------------------------------
                ...
                var tw_des_wrap = new TimelineMax()
                    ...
                    .fromTo( _srv_tags_wrp, 2, {x: "0%" }, { x: _tag_max_width * (-1) }, "start_design" )


                    // curves animate
                    //----------------------------------
                    .to( _srv_bsc_curve_1, 2, {strokeDasharray: svg_getLength(_srv_bsc_curve_1), strokeDashoffset: 0}, "start_design+=.2")
                    .to( _srv_bsc_curve_2, 2, {strokeDasharray: svg_getLength(_srv_bsc_curve_2), strokeDashoffset: 0}, "start_design")
                ...
                if ( $('.card-template-wrap').length ) {
                    ...
                    var $_brd_card_scrll_w = $('.card-template-wrap'),
                        ...
                        tw_brd_card_scrl = new TimelineMax()
                            .to($_brd_card_scrll, 1, { css: {backgroundPosition: "130% center" } } ),
        ...
        if ($('body').hasClass('page-srv-cloud')) {
            ...
            var _cst_flow_wrap = $('.customer-flow'),
                ...
                _crv_cst_cont   = $('.illus-custom-eng  .area-illus', _cst_flow_wrap),
            ...
            var tw__crv_cst_ = new TimelineMax()
                ...
                // curves animate
                //----------------------------------
                .to( _crv_cst_eng, 2, {strokeDasharray: svg_getLength(_crv_cst_eng), strokeDashoffset: 0}, "start_cloud-=.5")
        ...
        if ( $('body').hasClass('page-srv-web-eng')) {
            ...
            var _v_ux_des = $('.area-ux-ui'),
                ...
                _tw_ux = new TimelineMax()
                    .delay(1.5)
                    .addLabel("start")
                    .staggerFromTo(_v_ux_img, 1, { yPercent:"100%", autoAlpha:0}, {yPercent:"0%", autoAlpha:1}, .15 );
            ...
            if ( $('body').hasClass('page-srv-bespoke') ) {
                ...
                // THIS IS EXPERIMENTAL
                    ...
                    $_s_bf_itms.each(function (i,v) {
                        ...
                        $_s_bf_newTimeline.fromTo( $('.num-list',_t_m_child_ ), 10 , {x: -200}, {  x: 0, ease: Circ.out }, " BCSala"  );
                ...
                var _tw_bf_header = new TimelineMax()
                    ...
                    .staggerTo( $_bf_chits, .7 , { yPercent:"0" }, .2, "bf_hd_start" )
                    .to( $_bf_chit_l, .25 , { yPercent:"0" , autoAlpha:1, ease:Circ.out })
                    .staggerTo( $_bf_chit_k, .5, { yPercent: "0", autoAlpha: 1 }, .25, "bf_hd_start+=0.5" )
                    .to( $_bf_hd_txt_sm, .5, { yPercent: "0", autoAlpha: 1 }, "bf_hd_start+=2.5" )
                    .to( $_bf_hd_txt_lg, 1, { yPercent: "0", autoAlpha: 1 }, "bf_hd_start+=1.75" );
        ...
        if( $('.vert-scroll-wrap').length) {
            ...
            var _xvrt_wrap = $('.vert-scroll-wrap')
                .each(function (i,v) {
                    var _xv_t = $(this),
                        _xvrt_cont = $('.x-vert-scroll', _xv_t),
                        _x_scroll_width = $.trim( _xv_t.attr('data-vscroll-limit')) ? _xv_t.attr('data-vscroll-limit') : Math.abs( x_get_child_width(_xvrt_cont) - _xv_t.width()),
                        _x_trig_hook = $.trim( _xv_t.attr('data-vscroll-hook')) ? _xv_t.attr('data-vscroll-hook') : 0,
            ...
            var _x_tt = $('.vert-scroll-wrap .v-container').each(function (i,v) {

                var _x_v_child_h = $('.v-container > div').each( function (j,w) {

                   var _x_v_child = $(this),

                       _x_tw_v_child_ = new TimelineMax()
                           .fromTo($('h3',_x_tw_v_child_), 1, { xPercent: 50, autoAlpha:0 }, {  xPercent: 0, autoAlpha:1 } );
                        })
...
// </editor-fold>
    ...
    function hide_menu (ele) {
        ...
        new TimelineMax().staggerFromTo( $__mn_itms, .35, { y:"0%", opacity: 1 }, { y: "+=30%", opacity: 0 }, -.125 , null, function () {
    	    ...
    	    if ( $($obj).length ) {
                ...
                $($obj).each(function (i, v) {
                    ...
                    var $img = jQuery(this),
                        ...
                        imgURL = $img.is('img') ? $img.attr('src') : $img.attr('data-src');
        ...
        $($svg_r).each(function (i,v) {
            ...
            if ( _item.tagName.toLowerCase() == 'svg' ) {
                ...
                try {
                    ...
                    if ( _item.getBBox() !== null || _item.getBBox() !== 'undefined' || _item.getScreenCTM() !== 'undefined' ) {
            ...
            if ( img.complete || img.readyState === 4 ) {
                ...
                $(img).load( function (e) {
                    ...
                    if ( _imgsLoaded == imagesLimit ) {
                        ...
                        x_console('$(img).load(  _imgsLoaded == imagesLimit  ')();
                        x_run_callback( callback );
                        console.log("Total number of assets loaded, " +  _imgsLoaded)

                    } else {
                        x_console('$(img).load(  _imgsLoaded == imagesLimit   ELSE 1959' )();
                        // If not all images are loaded call own function again
                        _load_all_images(callback);
                   ...
                   x_console('on error 1967')();
                    //Increment the images loaded variable
                    console.log('Image is 404' + "path is: " + $(img).attr('src'));
