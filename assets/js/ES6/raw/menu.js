...
let _target_menu = '.navbar-toggle',
...
jQuery(document).ready(function ($) {
	...
	let is_home = $('body').hasClass('homepage');
	...
	let stick_start = get_menu_btn_pos( '.super-navigation' ),
		$_body		= $('body'),
		waiting		= false ;
	...
	if ( is_home && ! is_home ) {
		...
		$(window).on( 'scroll', function () {
			...
			utils.scroll_event_trigger( utils.sticky_test_add('sticky' , stick_start ), 150 );
		});
	}
